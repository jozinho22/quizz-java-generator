package com.douineau.qjgenerator.dao.insert;
...
public class InsertEvent {
	...
	public void process() throws IOException, QuestionException, ReponsesException {
...
//		}
	...
	private String getEndRepere(String s) {

		return s.replace("<", "</");
	}


	private void addJavaStyleQuestionText(Question q) {
...
//		System.out.println("newJavaCode - " + newJavaCode);
	...
	private List<String> getJavaCodes(String codeQuestion, int debutCode) {
...
//				System.out.println(codeQuestion);
	...
	private String fillWithContext(String javaCode, String tag) {
		StringBuilder sb = new StringBuilder();
	...
	private void addItemsToResponseText(List<String> items, Reponse r) {
	...
	private void deleteNoneTag(Question q) {
		String replace = q.getTexte().replace("<none>", "");
		q.setTexte(replace);
	}

	private void deleteNoneTag(Reponse r) {
		String replace = r.getTexte().replace("<none>", "");
		r.setTexte(replace);
	}

	private void addBlanksToResponseText(Reponse r) {
	...
	private void checkNbReponses(Question q, List<Boolean> booleans) throws ReponsesException {
		boolean ok = false;
	...
	private void addItemsToQuestionText(List<String> items, Question q) {
	...
	private void printCountByTopic(List<Question> questions) {
